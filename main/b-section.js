...
if (!localStorage.getItem('bcart')) {
  localStorage.setItem('bcart', JSON.stringify([]));
}

let bProducthtml = '';

bprods.forEach (product => {
...
document.querySelector('.js-prod-grid').innerHTML = bProducthtml;
